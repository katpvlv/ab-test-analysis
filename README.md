...
**👉 [Открыть ноутбук в Google Colab](https://colab.research.google.com/github/katpvlv/ab-test-analysis/blob/main/AB_test.ipynb)** — посмотреть анализ без установки Jupyter
